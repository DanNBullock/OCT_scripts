function analyzeSubjectOCTDataWrapper(inputSubjectDir,outputSubjectDir,centroidDataDir ,visFieldDiameterLimit, retinaMeanToggle,smoothParam,threshFloor)
...
%
%  centroidDataDir:  path to the directory containing the CSV data indicating
%  the centroid of the associated eye
%
...
for iAnalysis=1:length(inputFileNames)  %loop over input files
    ...
    currentCentroidFile=fullfile(centroidDataDir,centroidFiles{centroidFileIndex});
